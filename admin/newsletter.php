        ...
        <div style="max-width: 500px; margin:auto;">
            ...
            <form method="post" id="form_newsletter">
                <div class="mb-3">
                    ...
                    <input type="text" name="subject" octavalidate="R,TEXT" class="form-control" id="inp_title"
                        placeholder="Enter a good title">
                </div>
                <div class="mb-3">
                    <label class="form-label">Type in the message</label>
                    <textarea octavalidate="R,TEXT" id="inp_msg" name="message" class="form-control"
                        placeholder="Today is ..."></textarea>
                </div>
                <div class="mb-2">
