                                   ...
                                   <div class="row gx-5 bg-white">
                                        ...
                                        <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                                             <div class="d-flex align-items-center">
                                                  ...
                                                  <div class="number"><strong class="text-lg">$3000</strong></div>
                                             </div>
                                        </div>
                                        <!-- Item -->
                                        <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                                             <div class="d-flex align-items-center">
                                                  ...
                                                  <div class="number"><strong class="text-lg">$5000</strong></div>
                                             </div>
                                        </div>
                                        <!-- Item -->
                                        <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                                        ...
                                        <div class="col-xl-3 col-sm-6 py-4">
                                             <div class="d-flex align-items-center">
                                                  ...
                                                  <div class="number"><strong class="text-lg">$ 2000</strong></div>
                                             </div>
                                        </div>
                                   </div>
                              </div>
                                   ...
                                   <div class="card mb-3">
                                        <div class="card-body">
                                             <div class="d-flex align-items-center">
                                                  ...
                                                  <div class="ms-3"><strong class="text-lg d-block lh-1 mb-1">$2500</strong><small class="text-uppercase text-gray-500 small d-block lh-1">Total Investment Plans</small></div>
                                             </div>
                                        </div>
                                   </div>
                                   <div class="card mb-3">
